...
public class FittingCollection extends BaseEveData
{
    private static final long serialVersionUID = 965041169279751564L;
    public static final String PostBase = "application/vnd.ccp.eve.FittingCreate";
    public static final String GetBase = "application/vnd.ccp.eve.FittingCollection";
...
//        enforceRights(clientInfo, AccessGroup);
        ...
        CrestRequestData rdata = new CrestRequestData(
                        ...
                        gson, null, FittingCollection.class,
    ...
    public static Future<EveData> getContactsXml(CrestClientInfo clientInfo, CrestResponseCallback callback) throws RightsException
    {
        ...
        CrestRequestData rdata = new CrestRequestData(
                        clientInfo, getCrestUrl(clientInfo),
                        null, null, FittingCollection.class,
                        callback,
