...
public class TournamentMatchElement extends BaseEveData implements JsonDeserializer<TournamentMatchElement>
{
    ...
    public static final String GetBase = "application/vnd.ccp.eve.TournamentMatch";
    ...
    public static Future<EveData> getFuture(CrestResponseCallback callback) throws Exception
    {
        ...
        CrestRequestData rdata = new CrestRequestData(
                        null, getUrl(),
                        gson.create(), null, TournamentMatchElement.class,
                        callback,
    ...
    @Override
    public TournamentMatchElement deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException
    {
