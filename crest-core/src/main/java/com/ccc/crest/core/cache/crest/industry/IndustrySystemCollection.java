...
public class IndustrySystemCollection extends BaseEveData implements JsonDeserializer<IndustrySystemCollection>
{
    ...
    public static final String VersionBase = "application/vnd.ccp.eve.IndustrySystemCollection";
    ...
    public static Future<EveData> getFuture(CrestResponseCallback callback) throws Exception
    {
        ...
        CrestRequestData rdata = new CrestRequestData(
                        null, getUrl(),
                        gson.create(), null, IndustrySystemCollection.class,
                        callback,
    ...
    @Override
    public IndustrySystemCollection deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException
    {
        return null;
    }
}
