...
*/
package com.ccc.crest.core.cache.crest.system;
...
public class SystemCollection extends BaseEveData implements JsonDeserializer<SystemCollection>
{
    ...
    public static final String VersionBase = "application/vnd.ccp.eve.SystemCollection";
    ...
    @Override
    public SystemCollection deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException
    {
        return null;
    }
}
