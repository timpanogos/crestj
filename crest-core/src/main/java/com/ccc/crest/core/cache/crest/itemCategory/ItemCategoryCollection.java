...
*/
package com.ccc.crest.core.cache.crest.itemCategory;
...
public class ItemCategoryCollection extends BaseEveData implements JsonDeserializer<ItemCategoryCollection>
{
    ...
    public static final String VersionBase = "application/vnd.ccp.eve.ItemCategoryCollection";
    ...
    public static Future<EveData> getFuture(String url, CrestResponseCallback callback) throws Exception
    {
        ...
        CrestRequestData rdata = new CrestRequestData(
                        null, url,
                        gson.create(), null, ItemCategoryCollection.class,
                        callback,
    ...
    @Override
    public ItemCategoryCollection deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException
    {
        return null;
    }
}
