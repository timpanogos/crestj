...
*/
package com.ccc.crest.core.cache.crest.marketType;
...
public class MarketTypePriceCollection extends BaseEveData implements JsonDeserializer<MarketTypePriceCollection>
{
    ...
    public static final String VersionBase = "application/vnd.ccp.eve.MarketTypePriceCollection";
    ...
    public static Future<EveData> getFuture(String url, CrestResponseCallback callback) throws Exception
    {
        ...
        gson.registerTypeAdapter(MarketTypePriceCollection.class, new MarketTypePriceCollection());
        //@formatter:off
        CrestRequestData rdata = new CrestRequestData(
                        null, url,
                        gson.create(), null, MarketTypePriceCollection.class,
                        callback,
    ...
    @Override
    public MarketTypePriceCollection deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException
    {
        return null;
    }
}
