...
public class TournamentTeam extends BaseEveData implements JsonDeserializer<TournamentTeam>
{
    ...
    public static final String GetBase = "application/vnd.ccp.eve.TournamentTeam";
    ...
    public static Future<EveData> getFuture(CrestResponseCallback callback) throws Exception
    {
        ...
        CrestRequestData rdata = new CrestRequestData(
                        null, getUrl(),
                        gson.create(), null, TournamentTeam.class,
                        callback,
    ...
    @Override
    public TournamentTeam deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException
    {
