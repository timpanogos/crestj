...
*/
package com.ccc.crest.core.cache.crest.race;
...
public class RaceCollection extends BaseEveData implements JsonDeserializer<RaceCollection>
{
    ...
    public static final String VersionBase = "application/vnd.ccp.eve.RaceCollection";
    ...
    public static Future<EveData> getFuture(String url, CrestResponseCallback callback) throws Exception
    {
        ...
        CrestRequestData rdata = new CrestRequestData(
                        null, url,
                        gson.create(), null, RaceCollection.class,
                        callback,
    ...
    @Override
    public RaceCollection deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException
    {
        return null;
    }
}
