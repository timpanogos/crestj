...
*/
package com.ccc.crest.core.cache.crest.marketGroup;
...
public class MarketGroupCollection extends BaseEveData implements JsonDeserializer<MarketGroupCollection>
{
    ...
    public static Future<EveData> getFuture(CrestResponseCallback callback) throws Exception
    {
        ...
        gson.registerTypeAdapter(MarketGroupCollection.class, new MarketGroupCollection());
        //@formatter:off
    ...
    @Override
    public MarketGroupCollection deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException
    {
        return null;
    }
}
