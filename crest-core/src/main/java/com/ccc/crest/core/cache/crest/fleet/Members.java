...
public class Members extends BaseEveData
{
    private static final long serialVersionUID = 965041169279751564L;
    public static final String PostBase = "application/vnd.ccp.eve.FleetMemberInvite";
    public static final String GetBase = "application/vnd.ccp.eve.FleetMembers";
