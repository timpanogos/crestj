...
*/
package com.ccc.crest.core.cache.crest.industry;
...
public class IndustryFacilityCollection extends BaseEveData implements JsonDeserializer<IndustryFacilityCollection>
{
    ...
    public static final String VersionBase = "application/vnd.ccp.eve.IndustryFacilityCollection";
    ...
    public static Future<EveData> getFuture(CrestResponseCallback callback) throws Exception
    {
        ...
        CrestRequestData rdata = new CrestRequestData(
                        null, getUrl(),
                        gson.create(), null, IndustryFacilityCollection.class,
                        callback,
    ...
    @Override
    public IndustryFacilityCollection deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException
    {
        return null;
    }
}
