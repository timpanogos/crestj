...
public class ContactElement extends BaseEveData
{
    private static final long serialVersionUID = 965041169279751564L;
    public static final String PostBase = null;
    public static final String GetBase = null;
    public static final String PutBase = "application/vnd.ccp.eve.ContactCreate";
    public static final String DeleteBase = "application/vnd.ccp.eve.ContactDelete";
...
//        enforceRights(clientInfo, AccessGroup);
        ...
        CrestRequestData rdata = new CrestRequestData(
                        ...
                        gson, null, ContactElement.class,
    ...
    public static Future<EveData> getContactsXml(CrestClientInfo clientInfo, CrestResponseCallback callback) throws RightsException
    {
        ...
        CrestRequestData rdata = new CrestRequestData(
                        clientInfo, getUrl(clientInfo),
                        null, null, ContactElement.class,
                        callback,
