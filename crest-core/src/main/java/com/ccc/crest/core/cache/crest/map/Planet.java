...
public class Planet extends BaseEveData implements JsonDeserializer<Planet>
{
    ...
    public static final String GetBase = "application/vnd.ccp.eve.Planet";
