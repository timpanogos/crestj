...
*/
package com.ccc.crest.core.cache.crest.marketPrice;
...
public class MarketTypeCollection extends BaseEveData implements JsonDeserializer<MarketTypeCollection>
{
    ...
    public static final String VersionBase = "application/vnd.ccp.eve.MarketTypeCollection";
    ...
    @Override
    public MarketTypeCollection deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException
    {
        return null;
    }
}
