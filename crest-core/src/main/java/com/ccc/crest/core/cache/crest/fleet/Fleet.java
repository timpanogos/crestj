...
public class Fleet extends BaseEveData
{
    private static final long serialVersionUID = 965041169279751564L;
    public static final String PostBase = null;
    public static final String GetBase = "application/vnd.ccp.eve.Fleet";
    public static final String PutBase = "application/vnd.ccp.eve.FleetUpdate";
