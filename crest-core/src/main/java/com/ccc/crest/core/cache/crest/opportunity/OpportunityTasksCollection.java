...
public class OpportunityTasksCollection extends BaseEveData implements JsonDeserializer<OpportunityTasksCollection>
{
    ...
    public static final String VersionBase = "application/vnd.ccp.eve.OpportunityTasksCollection";
    ...
    public static Future<EveData> getFuture(CrestResponseCallback callback) throws Exception
    {
        ...
        gson.registerTypeAdapter(OpportunityTasksCollection.class, new OpportunityTasksCollection());
        //@formatter:off
        CrestRequestData rdata = new CrestRequestData(
                        null, getUrl(),
                        gson.create(), null, OpportunityTasksCollection.class,
                        callback,
    ...
    @Override
    public OpportunityTasksCollection deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException
    {
        return null;
    }
}
