...
public class TournamentBanCollection extends BaseEveData implements JsonDeserializer<TournamentBanCollection>
{
    ...
    public static final String GetBase = "application/vnd.ccp.eve.TournamentTypeBanCollection";
    ...
    public TournamentBanCollection()
    {
    }
    ...
    public static Future<EveData> getFuture(CrestResponseCallback callback) throws Exception
    {
        ...
        CrestRequestData rdata = new CrestRequestData(
                        null, getUrl(),
                        gson.create(), null, TournamentBanCollection.class,
                        callback,
    ...
    @Override
    public TournamentBanCollection deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException
    {
