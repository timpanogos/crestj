...
public class WarsElement extends BaseEveData implements JsonDeserializer<WarsElement>
{
    ...
    public static final String GetBase = "application/vnd.ccp.eve.War";
    ...
    public static Future<EveData> getFuture(CrestResponseCallback callback) throws Exception
    {
        ...
        CrestRequestData rdata = new CrestRequestData(
                        null, getUrl(),
                        gson.create(), null, WarsElement.class,
                        callback,
    ...
    @Override
    public WarsElement deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException
    {
        return null;
    }
}
