...
*/
package com.ccc.crest.core.cache.crest.incursion;
...
public class IncursionCollection extends BaseEveData implements JsonDeserializer<IncursionCollection>
{
    ...
    public static final String VersionBase = "application/vnd.ccp.eve.IncursionCollection";
    ...
    public static Future<EveData> getFuture(CrestResponseCallback callback) throws Exception
    {
        ...
        CrestRequestData rdata = new CrestRequestData(
                        null, getUrl(),
                        gson.create(), null, IncursionCollection.class,
                        callback,
    ...
    @Override
    public IncursionCollection deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException
    {
        return null;
    }
}
