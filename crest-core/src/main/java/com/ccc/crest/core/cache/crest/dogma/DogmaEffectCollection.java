...
public class DogmaEffectCollection extends BaseEveData implements JsonDeserializer<DogmaEffectCollection>
{
    ...
    public static final String VersionBase = "application/vnd.ccp.eve.DogmaEffectCollection";
    ...
    public static Future<EveData> getFuture(String url, CrestResponseCallback callback) throws Exception
    {
        ...
        CrestRequestData rdata = new CrestRequestData(
                        null, url,
                        gson.create(), null, DogmaEffectCollection.class,
                        callback,
    ...
    @Override
    public DogmaEffectCollection deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException
    {
        return null;
    }
}
