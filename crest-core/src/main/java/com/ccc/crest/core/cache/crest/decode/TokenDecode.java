...
*/
package com.ccc.crest.core.cache.crest.decode;
...
public class TokenDecode extends BaseEveData implements JsonDeserializer<TokenDecode>
{
    ...
    public static final String VersionBase = "application/vnd.ccp.eve.TokenDecode";
    ...
    public static Future<EveData> getFuture(CrestResponseCallback callback) throws Exception
    {
        ...
        CrestRequestData rdata = new CrestRequestData(
                        null, getUrl(),
                        gson.create(), null, TokenDecode.class,
                        callback,
    ...
    @Override
    public TokenDecode deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException
    {
        return null;
    }
}
