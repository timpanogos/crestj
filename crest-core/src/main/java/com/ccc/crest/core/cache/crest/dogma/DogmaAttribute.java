...
public class DogmaAttribute implements PagedItem, JsonDeserializer<DogmaAttribute>
{
    ...
    public DogmaAttribute(long id, String ticker, String name, String description, String corpUrl, String loyaltyUrl)
    {
        this.id = id;
        this.ticker = ticker;
        this.name = name;
    ...
    @Override
    public DogmaAttribute deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException
    {
