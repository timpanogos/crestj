...
public class TournamentPilotStatusCollection extends BaseEveData implements JsonDeserializer<TournamentPilotStatusCollection>
{
    ...
    public static final String GetBase = "application/vnd.ccp.eve.TournamentPilotStatsCollection";
    ...
    public TournamentPilotStatusCollection()
    {
    }
    ...
    public static Future<EveData> getFuture(CrestResponseCallback callback) throws Exception
    {
        ...
        CrestRequestData rdata = new CrestRequestData(
                        null, getUrl(),
                        gson.create(), null, TournamentPilotStatusCollection.class,
                        callback,
    ...
    @Override
    public TournamentPilotStatusCollection deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException
    {
