...
*/
package com.ccc.crest.core.cache.crest.opportunity;
...
public class OpportunityGroupsCollection extends BaseEveData implements JsonDeserializer<OpportunityGroupsCollection>
{
    ...
    public static final String VersionBase = "application/vnd.ccp.eve.OpportunityGroupsCollection";
    ...
    public OpportunityGroupsCollection()
    {
    }
    ...
    public static Future<EveData> getFuture(String url, CrestResponseCallback callback) throws Exception
    {
        ...
        gson.registerTypeAdapter(OpportunityGroupsCollection.class, new OpportunityGroupsCollection());
        //@formatter:off
        CrestRequestData rdata = new CrestRequestData(
                        null, url,
                        gson.create(), null, OpportunityGroupsCollection.class,
                        callback,
    ...
    @Override
    public OpportunityGroupsCollection deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException
    {
        return null;
    }
}
