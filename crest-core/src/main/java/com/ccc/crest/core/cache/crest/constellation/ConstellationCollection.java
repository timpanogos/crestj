...
*/
package com.ccc.crest.core.cache.crest.constellation;
...
public class ConstellationCollection extends BaseEveData implements JsonDeserializer<ConstellationCollection>
{
    ...
    public static final String VersionBase = "application/vnd.ccp.eve.ConstellationCollection";
    ...
    public static Future<EveData> getFuture(CrestResponseCallback callback) throws Exception
    {
        ...
        CrestRequestData rdata = new CrestRequestData(
                        null, getUrl(),
                        gson.create(), null, ConstellationCollection.class,
                        callback,
    ...
    @Override
    public ConstellationCollection deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException
    {
        return null;
    }
}
