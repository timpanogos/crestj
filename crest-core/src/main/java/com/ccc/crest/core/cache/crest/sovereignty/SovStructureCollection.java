...
public class SovStructureCollection extends BaseEveData implements JsonDeserializer<SovStructureCollection>
{
    ...
    public static final String VersionBase = "application/vnd.ccp.eve.SovStructureCollection";
    ...
    public static Future<EveData> getFuture(CrestResponseCallback callback) throws Exception
    {
        ...
        CrestRequestData rdata = new CrestRequestData(
                        null, getUrl(),
                        gson.create(), null, SovStructureCollection.class,
                        callback,
    ...
    @Override
    public SovStructureCollection deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException
    {
        return null;
    }
}
