...
public class WarsCollection extends BaseEveData implements JsonDeserializer<WarsCollection>
{
    ...
    public static final String VersionBase = "application/vnd.ccp.eve.WarsCollection";
    ...
    public static Future<EveData> getFuture(String url, CrestResponseCallback callback) throws Exception
    {
        ...
        CrestRequestData rdata = new CrestRequestData(
                        null, url,
                        gson.create(), null, WarsCollection.class,
                        callback,
    ...
    @Override
    public WarsCollection deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException
    {
        return null;
    }
}
