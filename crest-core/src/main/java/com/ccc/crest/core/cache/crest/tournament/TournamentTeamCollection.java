...
public class TournamentTeamCollection extends BaseEveData implements JsonDeserializer<TournamentTeamCollection>
{
    ...
    public static final String GetBase = "application/vnd.ccp.eve.TournamentTeamCollection";
    ...
    public TournamentTeamCollection()
    {
    }
    ...
    public static Future<EveData> getFuture(CrestResponseCallback callback) throws Exception
    {
        ...
        CrestRequestData rdata = new CrestRequestData(
                        null, getUrl(),
                        gson.create(), null, TournamentTeamCollection.class,
                        callback,
    ...
    @Override
    public TournamentTeamCollection deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException
    {
