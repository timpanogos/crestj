...
*/
package com.ccc.crest.core.cache.crest.itemType;
...
public class ItemTypeCollection extends BaseEveData implements JsonDeserializer<ItemTypeCollection>
{
    ...
    public static final String VersionBase = "application/vnd.ccp.eve.ItemTypeCollection";
    ...
    public static Future<EveData> getFuture(CrestResponseCallback callback) throws Exception
    {
        ...
        CrestRequestData rdata = new CrestRequestData(
                        null, getUrl(),
                        gson.create(), null, ItemTypeCollection.class,
                        callback,
    ...
    @Override
    public ItemTypeCollection deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException
    {
        return null;
    }
}
