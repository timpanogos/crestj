...
import com.ccc.servlet.wicket.WicketServlet;
...
public abstract class CrestServlet extends WicketServlet implements ApiKeyEventListener
{
    public CrestServlet()
    {
    }
    ...
    {
        return CrestController.OauthImplClassDefault;
    }
