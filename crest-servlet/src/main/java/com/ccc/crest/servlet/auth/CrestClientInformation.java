...
public class CrestClientInformation extends BaseClientInformation
{
    ...
    public synchronized String getCharacterId()
    {
        return characterId;
    }

    public synchronized void setCharacterId(String characterId)
    {
    ...
    public synchronized String getExpiresOn()
    {
        return expiresOn;
    }

    public synchronized void setExpiresOn(String expiresOn)
    {
