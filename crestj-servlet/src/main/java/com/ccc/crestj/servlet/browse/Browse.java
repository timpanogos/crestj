package com.ccc.crestj.servlet.browse;
...
import com.ccc.crestj.servlet.browse.filter.Filter;
import com.ccc.crestj.servlet.browse.filter.FilterForm;
...
public class Browse extends WebPage
{
    ...
    public Browse(final PageParameters parameters)
    {
        ...
        if (parameters != null)
        {
            ...
            {
                if (repo != null)
                    repo = URLDecoder.decode(repo, "UTF-8");
                if (submitter != null)
                    submitter = URLDecoder.decode(submitter, "UTF-8");
                if (publish != null)
                    publish = URLDecoder.decode(publish, "UTF-8");
        ...
        // try {
        // interfaces = getCore().getAllInterfaces(authUser, repo, submitter,
        // null, isPublished);
        // } catch (Exception e) {
        ...
        // InterfaceDataView("browseTable", new
