...
import com.ccc.crestj.servlet.auth.UserAuthenticationHandler.AuthenticateUserData;

@SuppressWarnings({ "javadoc" })
public final class EveSignInPage extends WebPage
{
    private static final long serialVersionUID = 1L;

    public EveSignInPage(final PageParameters parameters)
    {
        super(parameters);
