package org.opendof.tools.repository.interfaces.servlet.menu.manage;
...
import org.opendof.tools.repository.interfaces.servlet.menu.ConfirmPanel;
import org.opendof.tools.repository.interfaces.servlet.menu.ConfirmationHandler;
import org.opendof.tools.repository.interfaces.servlet.menu.ConfirmationLink;
import org.opendof.tools.repository.interfaces.servlet.menu.ConfirmationModalWindow;
import org.opendof.tools.repository.interfaces.servlet.menu.FormConfirmationLink;
import org.opendof.tools.repository.interfaces.servlet.menu.NotificationPanel;
...
public class ManageInterfacePanel extends Panel {
	...
	private void setPublishWindowMessages(){
		...
		String confirmMsg2 = "Published interfaces cannot be deleted. Changes to published interface definitions " +
							 "are restricted to documentation, so ensure that you have completed your organization's " +
	...
	private class SubmitConfirmationHandler implements ConfirmationHandler, WindowClosedCallback{
		...
		public void onConfirm(AjaxRequestTarget target) {			
			try {
				...
				isError = true;
				errorMessage = "Attempting to modify an immutable element/attribute of a published interface. " +
							   "Only metadata may be modified on published interfaces.";
			}
			catch (Exception e) {
				isError = true;
	...
	private class AccessConfirmPanel extends ConfirmPanel{
		...
		public AccessConfirmPanel(ModalWindow window, ConfirmationHandler confirmationHandler, String confirmationMsg1,
				String confirmationMsg2, String confirmText, String cancelText, String selectedAccess) {
